...
<template>
  <form @submit.prevent="register">
    ...
    >
      <p class="text-lg my-3">Chihomes</p>
      <div
        class="flex-col gap-5 flex items-center justify-center bg-white max-w-[90%] shadow-lg p-7"
      >
        ...
        <div class="p min-w-[200px] w-full flex-1">
          ...
          <div
            class="border rounded-xl w-full flex items-center justify-center mt-1 relative"
          >
            <input
        ...
        <div class="gap-2 flex items-center justify-start w-full">
          <input type="checkbox" />
          <p
            class="text-sm font-medium mobile:text-[10px] whitespace-nowrap text-lightText"
          >
            I agree with
            <span class="text-primary">privacy policy & terms</span>
          </p>
        </div>
        <div class="flex items-center w-full justify-center">
          <button
            class="w-full bg-adminPrimary flex-1 text-white py-2"
            v-on:click="register()"
          >
            REGISTER
          </button>
      ...
      <div class="mt-5 flex items-center justify-center">
        <p class="text-medium text-lightText font-medium mobile:text-sm">
